...
```{r}
data <- read_csv('ASRS_DBOnline_sample.csv')
```
...
chat$chat(paste("What are some common issues that arrive in these anecdotes. Tailor your answer to an investigative journalist that wants to try to investigate wrongdoings or mistakes in air travel.",data$narrative_121))
