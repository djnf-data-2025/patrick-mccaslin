...
#lets us use AI within the code
...
#CPU has cores. This sets up an environment where each core does its own thing at once.
...
#multisession creates the environment to do it
